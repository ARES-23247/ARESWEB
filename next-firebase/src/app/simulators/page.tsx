...
import { HelpCircle, RefreshCw, Info, Cpu, Sliders, AlertTriangle } from 'lucide-react';
      ...
      <div className="w-full max-w-7xl mx-auto px-6 py-12 md:py-20 flex flex-col items-center">
        ...
        <header className="text-center mb-12 w-full max-w-3xl">
          ...
          <h1 className="text-5xl md:text-7xl font-black tracking-tighter mb-6 uppercase font-heading">
            Kinematics <span className="bg-ares-red px-6 py-2 ares-cut shadow-xl text-white font-bold inline-block mt-2">Simulator</span>
          </h1>
          <p className="text-lg text-marble/60 max-w-2xl mx-auto font-medium leading-relaxed">
            Planar 2-DOF robotic joint arm solver. Visualize Trigonometry Forward Kinematics (FK) and Inverse Kinematics (IK) math in real-time.
          </p>
        </header>
