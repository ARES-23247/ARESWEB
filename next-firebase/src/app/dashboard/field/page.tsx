...
export default function FieldEditor() {
  ...
  useEffect(() => {
    if (!showCropModal || !rawUploadedImage) return;
  ...
  }, [showCropModal, rawUploadedImage, cropZoom, cropOffsetX, cropOffsetY, cropRotation, fieldType]);
  ...
  const applyCrop = () => {
    ...
    // Convert to Blob and set as localBgFile
    offscreen.toBlob((blob) => {
      if (blob) {
        const file = new File([blob], "cropped_background.png", { type: "image/png" });
        setLocalBgFile(file);
        
        // Immediately generate a local image URL for previewing on main canvas
  ...
  return (
    <div className="space-y-8">
      ...
      {showCropModal && rawUploadedImage && (
