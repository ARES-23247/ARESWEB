...
async function getGooglePhotosAccessToken() {
    ...
    const clientId = await (0, crypto_1.decrypt)(encryptedClientId, secret);
    const clientSecret = await (0, crypto_1.decrypt)(encryptedClientSecret, secret);
    const refreshToken = await (0, crypto_1.decrypt)(encryptedRefreshToken, secret);
