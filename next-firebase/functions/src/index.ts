...
// GET /api/photos/auth
app.get("/api/photos/auth", async (req: express.Request, res: express.Response) => {
  try {
...
// POST /api/inquiries
app.post("/api/inquiries", async (req: express.Request, res: express.Response) => {
  try {
...
app.post("/api/webhooks/zulip", async (req: express.Request, res: express.Response) => {
  try {
