import { sqliteTable, AnySQLiteColumn, index, text, numeric, integer, foreignKey, real, primaryKey, blob } from "drizzle-orm/sqlite-core"
...
export const documentContributors = sqliteTable("document_contributors", {
	...
	lastContributedAt: numeric("last_contributed_at").default(sql`(CURRENT_TIMESTAMP)`),
});
...
export const userProfilesFts = sqliteTable("user_profiles_fts", {
	...
	bio: numeric(),
	showOnAbout: numeric("show_on_about"),
	userProfilesFts: numeric("user_profiles_fts"),
	rank: numeric(),
});
