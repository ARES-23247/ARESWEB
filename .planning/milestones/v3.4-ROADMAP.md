# Milestone v3.4: Collaborative Editing Ecosystem
...
**Key Decisions:**
- Decision: Used native Yjs parsing rather than fetching from Liveblocks HTTP API for webhooks to preserve Prosemirror AST context directly.
- Decision: Added `content_draft` columns to isolate live CRDT drafting from production AST.
