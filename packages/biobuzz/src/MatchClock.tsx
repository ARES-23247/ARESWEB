...
export default function MatchClock({phase,tick=0,remaining=0,paused=false,compact=false}:{phase:Phase|"waiting"|"loading";tick?:number;remaining?:number;paused?:boolean;compact?:boolean}) {
