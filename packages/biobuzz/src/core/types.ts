...
export interface Input { x: number; y: number; turn: number; intake: boolean; shoot: boolean; speed: number; release: boolean; aimHive?:boolean }
...
export interface Robot extends Pose { id: number; alliance: Alliance; controller: SeatKind; inventory: number[]; shotStatus?:"aiming"|"blocked" }
