import { HEX_DIRECTIONS, createHexCoordinates } from "@ares/game-common/hex-grid";
...
export const BUZZELLO_DIRECTIONS = HEX_DIRECTIONS;

function coordinateKey(q: number, r: number): string {
  return `${q},${r}`;
}

export const BUZZELLO_COORDINATES = createHexCoordinates(BUZZELLO_BOARD_RADIUS, "column");
