...
- Name: admin-dashboard.spec.ts >> Admin Dashboard >> Admin dashboard loads and displays authorized management hubs
- Location: tests/e2e/admin-dashboard.spec.ts:10:3
...
Locator: getByText('Admin User', { exact: true }).first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('Admin User', { exact: true }).first()
