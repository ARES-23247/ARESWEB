...
You need a local FTC Starter project and ARES Robotics Studio 5.0.6.
...
*Studio 5.0.6 shows routine steps and field placement together. Review both views, then save,
