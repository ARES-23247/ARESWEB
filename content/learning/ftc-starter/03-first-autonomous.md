...
You need a local FTC Starter project and ARES Robotics Studio 4.0.1.
...
*Studio 4.0.1 shows routine steps and field placement together. Review both views, then save,
