...
You need a local FTC Starter project and ARES Robotics Studio 5.0.5.
...
*Studio 5.0.5 shows routine steps and field placement together. Review both views, then save,
