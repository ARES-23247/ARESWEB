...
You need a local FTC Starter project and ARES Robotics Studio 7.0.10.
...
*Archived Studio screenshot: Studio shows routine steps and field placement together. Review both views, then save,
