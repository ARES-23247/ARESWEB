...
You need a local FTC Starter project and ARES Robotics Studio 3.1.1.
...
*Studio 3.1.1 shows routine steps and field placement together. Review both views, then save,
