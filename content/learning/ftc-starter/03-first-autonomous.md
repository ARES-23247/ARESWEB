...
You need a local FTC Starter project and ARES Robotics Studio 5.0.3.
...
*Studio 5.0.3 shows routine steps and field placement together. Review both views, then save,
