...
This lesson follows ARES 15.0.2 and Studio 5.0.3. Its source links are pinned to the exact public
...
Now use the **ARES 15.0.2 source trace** in the same activity:
