...
This lesson follows ARES 14.0.0 and Studio 4.0.1. Its source links are pinned to the exact public
...
Now use the **ARES 14.0.0 source trace** in the same activity:
