...
This lesson follows ARES 15.0.4 and Studio 5.0.6. Its source links are pinned to the exact public
...
Now use the **ARES 15.0.4 source trace** in the same activity:
