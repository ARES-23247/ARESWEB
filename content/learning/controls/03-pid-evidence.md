...
This lesson follows ARES 16.0.1 and Studio 6.0.1. Its source links are pinned to the exact public
...
Now use the **ARES 16.0.1 source trace** in the same activity:
