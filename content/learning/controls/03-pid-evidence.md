...
This lesson follows ARES 12.0.0 and Studio 3.0.0. Its source links are pinned to the exact public
...
Now use the **ARES 12.0.0 source trace** in the same activity:
