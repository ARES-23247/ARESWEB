...
This lesson follows ARES 13.0.1 and Studio 3.1.2. Its source links are pinned to the exact public
...
Now use the **ARES 13.0.1 source trace** in the same activity:
