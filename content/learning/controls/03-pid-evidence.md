...
This lesson follows ARES 13.0.0 and Studio 3.1.1. Its source links are pinned to the exact public
...
Now use the **ARES 13.0.0 source trace** in the same activity:
