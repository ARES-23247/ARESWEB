...
This lesson matches ARES 17.0.2, FTC SDK 11.1.0, and Studio 7.0.3. Every source link is pinned to
...
ARES 17.0.2 has one more compile-level item when `zeroAllocationPeriodic` is selected. It records
