...
This lesson matches ARES 12.0.0, FTC SDK 11.1.0, and Studio 3.0.0. Every source link is pinned to
...
ARES 12.0.0 has one more compile-level item when `zeroAllocationPeriodic` is selected. It records
