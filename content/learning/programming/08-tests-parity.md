...
This lesson matches ARES 15.0.1, FTC SDK 11.1.0, and Studio 5.0.2. Every source link is pinned to
...
ARES 15.0.1 has one more compile-level item when `zeroAllocationPeriodic` is selected. It records
