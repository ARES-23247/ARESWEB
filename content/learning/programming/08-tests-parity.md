...
This lesson matches ARES 14.0.0, FTC SDK 11.1.0, and Studio 4.0.0. Every source link is pinned to
...
ARES 14.0.0 has one more compile-level item when `zeroAllocationPeriodic` is selected. It records
