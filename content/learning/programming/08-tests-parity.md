...
This lesson matches ARES 15.0.0, FTC SDK 11.1.0, and Studio 5.0.1. Every source link is pinned to
...
ARES 15.0.0 has one more compile-level item when `zeroAllocationPeriodic` is selected. It records
