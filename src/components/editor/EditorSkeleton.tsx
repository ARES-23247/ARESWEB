...
export default function EditorSkeleton() {
  return (
    <div className="flex flex-col h-full w-full bg-obsidian-surface animate-pulse" role="status" aria-label="Loading code editor">
      {/* Toolbar placeholder */}
      ...
      <div className="flex flex-1 overflow-hidden">
        <div className="w-12 h-full bg-black/60 border-r border-white/5 flex flex-col gap-1.5 p-2">
