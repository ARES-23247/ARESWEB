      ...
      <div className="flex flex-wrap items-center justify-between gap-2 p-1.5 bg-black/45 border-b border-white/10 select-none">
        ...
        <div className="flex flex-wrap items-center gap-0.5">
          ...
          <button
            ...
            disabled={mode === "preview" || disabled}
            className="w-7 h-7 flex items-center justify-center rounded text-marble/60 hover:text-white hover:bg-white/5 transition-colors focus:outline-none focus-visible:ring-1 focus-visible:ring-ares-cyan disabled:opacity-20 text-ares-red-light/90"
