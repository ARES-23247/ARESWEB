...
export function AresField({ field, label, type = "text", placeholder, required }: AresFieldProps) {
  return (
    <div className="w-full">
      ...
      {type === "textarea" ? (
        <textarea
          ...
          className="w-full bg-obsidian border border-white/10 ares-cut-sm px-4 py-3 text-white placeholder-white/40 focus:border-ares-red focus:outline-none focus:ring-1 focus:ring-ares-red transition-all min-h-[100px]"
        />
      ) : (
        <input
          id={field.name}
