      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 relative z-10">
        ...
        <div>
          ...
          <ul className="flex flex-col gap-3 text-[11px] font-bold uppercase tracking-widest text-marble/80">
            ...
            <li><Link to="/community/alumni" className="hover:text-ares-gold transition-colors flex items-center gap-2">Alumni & Mentorship</Link></li>
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-2 mb-8">
            ...
            <a href={`https://www.linkedin.com/${siteConfig.urls.linkedin}`} target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/5 rounded-lg flex items-center justify-center hover:bg-ares-bronze transition-all hover:-translate-y-1 text-white border border-white/5 shadow-xl focus:outline-none focus-visible:ring-2 focus-visible:ring-ares-cyan" aria-label="LinkedIn">
