    ...
    <footer className="w-full bg-obsidian text-marble border-t border-ares-bronze/20 pt-16 pb-8 overflow-hidden relative">
      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12 relative z-10">
        ...
        <div>
          ...
          <Link to="/bug-report" className="bg-ares-red text-white hover:bg-white hover:text-ares-red px-4 py-2 rounded-lg transition-all font-bold uppercase tracking-widest text-xs inline-flex items-center gap-2 shadow-lg shadow-ares-red/20 w-fit mt-2">
