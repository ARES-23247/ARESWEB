      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 relative z-10">
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-2 mb-8">
            <a href="https://instagram.com/ares23247" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/5 rounded-lg flex items-center justify-center hover:bg-ares-red transition-all hover:-translate-y-1 text-white border border-white/5 shadow-xl font-bold focus:outline-none focus-visible:ring-2 focus-visible:ring-ares-cyan" aria-label="Instagram">
            ...
            <a href="https://www.youtube.com/@ARESFTC" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/5 rounded-lg flex items-center justify-center hover:bg-ares-red transition-all hover:-translate-y-1 text-white border border-white/5 shadow-xl font-bold focus:outline-none focus-visible:ring-2 focus-visible:ring-ares-cyan" aria-label="YouTube">
            ...
            <a href="https://www.facebook.com/ARES23247" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/5 rounded-lg flex items-center justify-center hover:bg-blue-600 transition-all hover:-translate-y-1 text-white border border-white/5 shadow-xl focus:outline-none focus-visible:ring-2 focus-visible:ring-ares-cyan" aria-label="Facebook">
            ...
            <a href={`https://tiktok.com/@${siteConfig.urls.tiktok}`} target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/5 rounded-lg flex items-center justify-center hover:bg-black transition-all hover:-translate-y-1 text-white border border-white/5 shadow-xl focus:outline-none focus-visible:ring-2 focus-visible:ring-ares-cyan" aria-label="TikTok">
              <svg aria-hidden="true" className="w-5 h-5 fill-current" viewBox="0 0 24 24"><path d="M12.525.02c1.31-.02 2.61.15 3.91.02 0 1.5.46 2.93 1.04 4.19.62 1.27 1.55 2.39 2.73 3.16v3.55c-1.73-.04-3.4-.6-4.82-1.54v6.83a6.76 6.76 0 0 1-2.04 4.83 6.98 6.98 0 0 1-4.93 2 6.76 6.76 0 0 1-4.79-1.97A6.6 6.6 0 0 1 1.61 17a6.83 6.83 0 0 1 4.62-6.4v3.56a3.42 3.42 0 0 0-1.37 2.72 3.39 3.39 0 0 0 1.02 2.44 3.5 3.5 0 0 0 2.48 1 3.49 3.49 0 0 0 2.44-1.05c.64-.66 1-1.55.98-2.47V.02h2.73z"/></svg>
            </a>
            ...
            <a href={`https://twitter.com/${siteConfig.urls.twitter}`} target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/5 rounded-lg flex items-center justify-center hover:bg-black transition-all hover:-translate-y-1 text-white border border-white/5 shadow-xl focus:outline-none focus-visible:ring-2 focus-visible:ring-ares-cyan" aria-label="X (Twitter)">
            ...
            <a href={`https://www.linkedin.com/${siteConfig.urls.linkedin}`} target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/5 rounded-lg flex items-center justify-center hover:bg-blue-800 transition-all hover:-translate-y-1 text-white border border-white/5 shadow-xl focus:outline-none focus-visible:ring-2 focus-visible:ring-ares-cyan" aria-label="LinkedIn">
            ...
            <a href="https://aresfirst.zulipchat.com" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/5 rounded-lg flex items-center justify-center hover:bg-ares-cyan transition-all hover:-translate-y-1 text-white border border-white/5 shadow-xl focus:outline-none focus-visible:ring-2 focus-visible:ring-ares-cyan" aria-label="Zulip Team Chat">
            ...
            <a href={`https://bsky.app/profile/${siteConfig.urls.bluesky}`} target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/5 rounded-lg flex items-center justify-center hover:bg-blue-400 transition-all hover:-translate-y-1 text-white border border-white/5 shadow-xl focus:outline-none focus-visible:ring-2 focus-visible:ring-ares-cyan" aria-label="Bluesky">
