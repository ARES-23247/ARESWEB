...
export default function ArcadePage() {
  return (
    <main className="mx-auto w-full max-w-7xl px-5 py-10 sm:px-8 sm:py-16">
      <SEO title="ARES Arcade" description="Play BUZZLE, BUZZELLO, Pollenator Pile-Up, and the Waggle Way playtest. Explore word games, hexagonal strategy, and physics challenges from ARES 23247." />
      <PageHeader
