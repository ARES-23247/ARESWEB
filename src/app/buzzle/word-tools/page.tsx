...
export default function BuzzleWordToolsPage() {
  ...
  return <main className="buzzle-shell min-h-screen px-4 pb-16 pt-24 text-marble sm:px-6 sm:pt-32">
    <SEO title="BUZZLE Word Tools" description="Check legal BUZZLE words, browse the two-letter list, and look up meanings while playing the physical game." url="/buzzle/word-tools" />
