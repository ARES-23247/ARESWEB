...
export default function DocumentsManagementPage() {
  ...
  const canManageDrive = authorizedUser?.role === "admin" || authorizedUser?.role === "coach";
  ...
  return (
    <div className="space-y-10 w-full text-left">
      ...
      {canManageDrive && <GoogleDriveLibraryBrowser />}
      ...
      <DocListGrid
        ...
        noItemsMessage="No documents indexed in the library. Create one or import selected Drive files as drafts to get started."
      />
