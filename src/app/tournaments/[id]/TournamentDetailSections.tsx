                  ...
                  {[...tournament.oprList]
                    ...
                    .map((team) => {
                      ...
                      return (
                        <tr
                          key={team.teamNumber}
                          className={`transition-colors ${isAres ? "bg-ares-red/10 text-white font-bold" : "text-marble/70 hover:bg-white/5"}`}
                        >
                          ...
                          <td
                            className={`px-4 py-3 text-right font-bold ${isAres ? "text-ares-gold" : "text-white"}`}
                          >
                            {team.opr}
                          </td>
                        </tr>
