...
describe("utils", () => {
  describe("cleanThumbnailUrl", () => {
    ...
    it("should normalize YouTube thumbnails onto a stable image host", () => {
      ...
      expect(cleanThumbnailUrl(cleanUrl)).toBe("https://i.ytimg.com/vi/BDPfxLz1HcY/hqdefault.jpg");
    });
    ...
    it("should preserve non-YouTube URLs after cleaning legacy paths", () => {
      expect(cleanThumbnailUrl("https://example.com/image.jpg")).toBe("https://example.com/image.jpg");
    });
  });
