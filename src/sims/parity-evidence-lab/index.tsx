...
const DEFAULTS = { scenario: "startup" as ScenarioId, platform: "untested" as Result, simulated: "untested" as Result };
...
export default function ParityEvidenceLab() {
  ...
  const reset = () => { setScenario(DEFAULTS.scenario); setPlatform(DEFAULTS.platform); setSimulated(DEFAULTS.simulated); };
