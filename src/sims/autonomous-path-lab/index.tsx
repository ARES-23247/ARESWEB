...
export default function AutonomousPathLab() {
  ...
  return <AcademyLabShell titleId="autonomous-path-title" title="Autonomous Path Clearance Lab" eyebrow="Concept model" description="Check one straight center-line path against one circular obstacle and a bumper margin." onReset={reset}>
    ...
    <AcademyModelLimit>This invented field checks one straight line against one circle. It does not parse `.aresroutine` files, sample ARES paths, use a costmap, model the robot footprint, check chained segments, execute code, or validate physical clearance.</AcademyModelLimit>
  </AcademyLabShell>;
}
