    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 overflow-x-hidden">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 px-4">
          ...
          <div className="mt-4 p-4 bg-white/5 border-l-2 border-ares-gold text-sm text-marble italic">
        ...
        <div className="max-w-4xl mx-auto space-y-12 mb-24">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold font-heading mb-4 text-ares-cyan">Championship-Grade Engineering Standards</h2>
            <p className="text-marble text-lg leading-relaxed">
          ...
          <div className="flex flex-col md:flex-row items-start gap-8">
            ...
            <div>
              ...
              <p className="text-marble text-lg leading-relaxed mb-4">
        ...
        <div className="max-w-4xl mx-auto space-y-12">
          ...
          <div className="flex flex-col md:flex-row items-start gap-8">
            ...
            <div>
              ...
              <div className="mb-6 p-4 bg-white/5 border-l-2 border-ares-red text-sm text-marble italic">
          ...
          <div className="bg-white/5 border-l-4 border-ares-gold p-8 hero-card mt-16 shadow-2xl">
            ...
            <p className="text-marble text-lg leading-relaxed italic">
