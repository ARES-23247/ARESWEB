  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-24">
      <div className="max-w-lg text-center">
        ...
        <p className="text-marble/90 mb-8 text-sm leading-relaxed">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          ...
          <Link
            to="/blog"
            className="px-6 py-3 bg-white/5 text-white font-bold uppercase text-xs tracking-widest ares-cut-sm hover:bg-white/10 border border-white/20 transition-all"
          >
            Read Blog
          </Link>
        </div>
