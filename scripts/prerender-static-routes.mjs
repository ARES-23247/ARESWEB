...
export const staticPageMetadata = [
  ...
  ["/safety", "Workshop Safety & Tool Certifications", "Explore ARES 23247 machine safety protocols, interactive tool qualification quizzes, and emergency workshop procedures."],
