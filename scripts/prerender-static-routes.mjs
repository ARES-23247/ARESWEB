...
export const staticPageMetadata = [
  ...
  ["/outreach/report", "Community Outreach & STEM Impact Report", "Comprehensive ARES 23247 Community Outreach & STEM Impact Report, featuring volunteer hours, students reached, public exhibits, and formula-safe CSV export."],
  ...
  ["/sponsors/packet", "Sponsorship Packet & Deck", "Official ARES 23247 sponsorship packet, 501(c)(3) tax-exempt details, sponsorship tier matrix, dynamic season metrics, and team budget allocations."],
