...
export const staticPageMetadata = [
  ...
  ["/robots/bom", "Robot Bill of Materials & Hardware BOM", "Explore the itemized engineering bill of materials, subsystem weights, and vendor catalog for ARES competition robots."],
