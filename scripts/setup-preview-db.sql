...
DROP TABLE IF EXISTS `posts_fts_data`;
DROP TABLE IF EXISTS `posts_fts_idx`;
DROP TABLE IF EXISTS `posts_fts_content`;
DROP TABLE IF EXISTS `posts_fts_docsize`;
DROP TABLE IF EXISTS `posts_fts_config`;
DROP TABLE IF EXISTS `events_fts`;
DROP TABLE IF EXISTS `events_fts_data`;
DROP TABLE IF EXISTS `events_fts_idx`;
DROP TABLE IF EXISTS `events_fts_content`;
DROP TABLE IF EXISTS `events_fts_docsize`;
DROP TABLE IF EXISTS `events_fts_config`;
DROP TABLE IF EXISTS `user_profiles_fts`;
DROP TABLE IF EXISTS `user_profiles_fts_data`;
DROP TABLE IF EXISTS `user_profiles_fts_idx`;
DROP TABLE IF EXISTS `user_profiles_fts_content`;
DROP TABLE IF EXISTS `user_profiles_fts_docsize`;
DROP TABLE IF EXISTS `user_profiles_fts_config`;
