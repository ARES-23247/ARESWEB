...
export const FUNCTION_SECRET_BINDINGS = {
  publicApi: [],
  coreApi: ["ENCRYPTION_SECRET", "RECAPTCHA_SECRET_KEY", "PROFILE_SYNC_SECRET", "ZULIP_BOT_EMAIL", "ZULIP_API_KEY"],
  mediaApi: [
  ...
  communicationsApi: ["GITHUB_PAT", "ZULIP_BOT_EMAIL", "ZULIP_API_KEY", "ZULIP_WEBHOOK_TOKEN", "BLUESKY_APP_PASSWORD", "BUFFER_API_KEY"],
} as const;
