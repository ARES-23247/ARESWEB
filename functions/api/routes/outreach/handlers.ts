...
export const handleListOutreach: RouteHandler<typeof listOutreachRoute> = async (c) => {
  try {
...
export const handleAdminListOutreach: RouteHandler<typeof adminListOutreachRoute> = async (c) => {
  try {
    const db = c.get("db") as Kysely<DB>;
    const results = await db.selectFrom("outreach_logs")
      .select([
...
export const handleSaveOutreach: RouteHandler<typeof saveOutreachRoute> = async (c) => {
  try {
...
export const handleDeleteOutreach: RouteHandler<typeof deleteOutreachRoute> = async (c) => {
  try {
