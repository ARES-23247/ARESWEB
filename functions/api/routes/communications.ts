...
const _communicationsRouter = new OpenAPIHono<AppEnv>();

// Require admin for all communications endpoints
_communicationsRouter.use("/mass-email", ensureAdmin);
_communicationsRouter.use("/stats", ensureAdmin);

// Get stats
export const communicationsRouter = _communicationsRouter
    ...
    .openapi(sendMassEmailRoute, async (c) => {
