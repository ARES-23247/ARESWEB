...
import { AppEnv, getSessionUser, MAX_INPUT_LENGTHS, getSocialConfig, persistentRateLimitMiddleware, ensureAuth, originIntegrityMiddleware, logAuditAction, getDb, requireAuth } from "../middleware";
...
export const commentsRouter = _commentsRouter
    ...
    .openapi(submitCommentRoute, async (c) => {
        const params = c.req.valid("param");
