...
const _githubWebhookRouter = new OpenAPIHono<AppEnv>();
...
export const githubWebhookRouter = _githubWebhookRouter
    .openapi(githubWebhookRoute, async (c) => {
        ...
        const payload: GitHubWebhookPayload = JSON.parse(rawBody) as GitHubWebhookPayload;
