...
- Name: admin-dashboard.spec.ts >> Admin Dashboard >> Logistics tab supports email export
- Location: tests/e2e/admin-dashboard.spec.ts:38:3
...
Locator: getByText(/Team Logistics/i)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText(/Team Logistics/i)
